...
SOC2ex = SOC20 - (P_Required/3600)/Cap1;
if P_Required == 0 % If the required power is zero then the if statement determines whether to try and balance the ESSs. 
    ...
    elseif SOC10 > 0.55 && SOC10 <= 1
        P_output1 = 0.1*2*Cap1; % This allows the battery to output 10%  of its power rating to try and balance
        P_output2 = 0;
...
elseif abs(P_Required) >= SC_lim && SO2ex 
